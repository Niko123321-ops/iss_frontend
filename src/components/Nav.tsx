                    ...
                    <div className="container">
                        <div className="row">
                            <div className="col-sm-8 col-md-7 py-4">
                                <h4 className="text-white">Ne vem</h4>
                                <p className="text-muted">Kaj delam</p>
                            </div>
...
/*<li ><button type="button" onClick={Submit} className="btn btn-sm btn-outline-secondary">Logout</button></li>*/